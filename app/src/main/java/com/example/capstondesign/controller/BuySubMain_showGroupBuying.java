...
import com.example.capstondesign.model.InShowGroupBuyingProfileCountTask;
...
public class BuySubMain_showGroupBuying extends AppCompatActivity {
    ...
    String strurl;
    InShowGroupBuyingProfileCountTask inShowGroupBuyingProfileCountTask;
    String real_nick;
    String message;
    Intent intent;
    int set, max_count;
    ...
    ShowGroupBuyingjson showGroupBuyingjson;
    com.example.capstondesign.model.addWatchlistTask addWatchlistTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inShowGroupBuyingProfileCountTask = new InShowGroupBuyingProfileCountTask();
        ...
        showGroupBuyingjson = new ShowGroupBuyingjson();
...
//        Log.d("positionNum", positionNum);
        ...
        for(int i = 0; i < Integer.parseInt(numberGroupBuying); i++) { // MySQL 길이
            if(i == 0) itemList.add(new BuySubSlideritem("http://13.124.75.92:8080/upload/" + ShowGroupBuyingAdapter.click_title.hashCode() + time + ".jpg"));
            else itemList.add(new BuySubSlideritem("http://13.124.75.92:8080/upload/" + ShowGroupBuyingAdapter.click_title.hashCode() + time +  i + ".jpg"));
        }
